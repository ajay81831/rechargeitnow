					...
					<div class="tab-content full-width-form">
						<div id="mobile" class="tab-pane fade in active">
							<form autocomplete="on" class="secondScreenForm">
								<div class="form_with-submit planBrowse coupon wow animated fadeInUp">
									<div class="col-md-4 group">
										<label>SUBSCRIBER ID/RMN</label> 
										<div class="customerDetailWrap">
											<span class="customerOperator">01507399992</span>
										</div>  
									</div>
									<div class="col-md-4 group">
										<label>SERVICE PROVIDER</label>
										<div class="customerDetailWrap">
											<span class="customerOperator">DishTV</span>
										</div>
									</div>
									
									<div class="col-md-4 group">
										<label>AMOUNT
											<a class="editAmount" href="">
												<i class="fa fa-pencil"></i>
												<span class="editCaption">Edit</span>
											</a>
										</label>
										<div class="customerDetailWrap">
											<span class="customerOperator">&#8377; 399</span>	
										</div>
									</div>
								</div>
								<div class="form_with-submit planBrowse coupon sm wow animated fadeInUp">
									...
									<div class="col-md-4 continueBtn">
										<a href="dth-fourth.php" id="payMoney">Continue</a>
									</div>
