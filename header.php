...
<!--BEGIN PAGE WRAPPER-->
  ...
  <!--BEGIN HEADER-->
    <div id="header">
      <div class="mobile-app-download hidden-sm hidden-md hidden-lg">
        <button><img src="assets/img/close.png"></button>
        <span>Download Our App</span>
        <ul>
          <li><a href=""><img src="assets/img/strip-google.png"></a></li>
          <li><a href=""><img src="assets/img/strip-apple.png"></a></li>
        </ul>
      </div>
      <div class="container">
          ...
          <div class="">
            <div class="navbar-header">
              ...
              <ul class="nav navbar-nav navbar-right hidden-sm hidden-md hidden-lg">
                <li><a href="#" class="login_register" data-toggle="modal" data-target="#myModal" data-dismiss="modal">login</a></li>
              </ul>
            </div>
            <div class="collapse navbar-collapse" id="myNavbar">
              <ul class="nav navbar-nav mobDropDown">
                ...
                <li><a href="services.php"><i><img src="assets/img/menu-icons/services.png"></i><span>services</span></a></li>
              ...
              <ul class="nav navbar-nav navbar-right hidden-xs">
                <li><a href="javascript:void(0);" class="login_register" data-toggle="modal" data-target="#myModal">login/register</a></li>
              </ul>
            </div>
          </div>
        </nav>
    ...
    <div class="modal-dialog modal-lg">
      <div id="loginDiv" class="modal-content loginScreen animated fadeIn">
        <div class="modal-header customerLoginModal">
          ...
          <ul class="nav nav-pills modalNav" id="popUpNav">
            <li class="active"><a data-toggle="pill" href="#login">login</a></li>
            <li><a data-toggle="pill" href="#register">register</a></li>
            <li><a data-toggle="pill" href="#guestLogin">guest login</a></li>
          </ul>
          <ul class="nav nav-pills modalNav" id="forgPass">

            <li class="active"><a data-toggle="pill">Forget Password</a></li>
          </ul>
        </div>
        <div class="modal-body">
          <div class="tab-content">
            ...
            <!--THIRD CONTENT-->
            <?php include_once 'guestLogin.php'; ?>
         </div>
        </div>
      </div>
