		...
		<div class="container mobileContainerFullWidth">
			...
			<div class="customerDetail">
				...
				<div class="totalOffer">
					<div class="control-group">
						<div class="checkbox">
							<label class="control control--checkbox partDisCheck">
				...
				<div class="unlockCoupon checkedOffer animated">
					...
					<div class="couponShop">
						...
						<ul id="couponShopHeader" class="nav nav-pills owl-carousel sliderheader">
							<li class="item selected"><a data-toggle="pill" href="#food">food</a></li>
							<li class="item"><a data-toggle="pill" href="#travel">travel</a></li>
							<li class="item"><a data-toggle="pill" href="#shopping">shopping</a></li>
							<li class="item"><a data-toggle="pill" href="#others">others</a></li>
							<li class="item"><a data-toggle="pill" href="#travel">travel</a></li>
							<li class="item"><a data-toggle="pill" href="#shopping">shopping</a></li>
							<li class="item"><a data-toggle="pill" href="#others">others</a></li>
						</ul>
				...
				<div class="unlockCoupon missedOffer hideon animated slideInLeft">
					...
					<div class="offer partnerOfferBlock">
